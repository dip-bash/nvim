...
vim.keymap.set("n", "gl", function() vim.diagnostic.open_float() end, -- Open diagnostics in a floating window
...
-- somwe shortcuts in plugin/fzf.lua file
-- somwe shortcuts in plugin/lsp.lua file